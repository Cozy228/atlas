...
export default function AzureOtherAzureStorageMover({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
