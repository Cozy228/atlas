...
export default function AzureGeneralProcessExplorer({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
