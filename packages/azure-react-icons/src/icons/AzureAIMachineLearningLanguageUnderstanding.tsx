...
export default function AzureAIMachineLearningLanguageUnderstanding({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
