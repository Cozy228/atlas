...
export default function AzureIoTDeviceProvisioningServices({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
