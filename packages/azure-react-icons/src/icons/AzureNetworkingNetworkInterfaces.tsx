...
export default function AzureNetworkingNetworkInterfaces({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
