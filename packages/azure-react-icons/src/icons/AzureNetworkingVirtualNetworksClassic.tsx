...
export default function AzureNetworkingVirtualNetworksClassic({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
