...
export default function AzureSecurityMicrosoftDefenderForCloud({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
