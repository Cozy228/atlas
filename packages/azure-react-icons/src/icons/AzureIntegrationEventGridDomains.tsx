...
export default function AzureIntegrationEventGridDomains({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
