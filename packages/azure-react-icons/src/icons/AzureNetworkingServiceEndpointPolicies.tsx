...
export default function AzureNetworkingServiceEndpointPolicies({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
