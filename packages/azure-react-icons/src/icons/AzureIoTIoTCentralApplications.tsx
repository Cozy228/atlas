...
export default function AzureIoTIoTCentralApplications({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
