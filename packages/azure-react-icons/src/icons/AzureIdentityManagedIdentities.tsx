...
export default function AzureIdentityManagedIdentities({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
