...
export default function AzureGeneralProductionReadyDatabase({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
