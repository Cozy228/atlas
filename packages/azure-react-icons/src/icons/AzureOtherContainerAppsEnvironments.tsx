...
export default function AzureOtherContainerAppsEnvironments({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
