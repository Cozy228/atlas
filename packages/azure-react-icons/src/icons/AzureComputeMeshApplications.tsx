...
export default function AzureComputeMeshApplications({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
