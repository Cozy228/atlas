...
export default function AzureSecurityExtendedsecurityupdates({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
