...
export default function AzureOtherAzureSupportCenterBlue({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
