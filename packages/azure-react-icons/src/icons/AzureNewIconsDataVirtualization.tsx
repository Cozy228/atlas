...
export default function AzureNewIconsDataVirtualization({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
