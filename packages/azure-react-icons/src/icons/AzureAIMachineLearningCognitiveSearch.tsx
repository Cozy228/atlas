...
export default function AzureAIMachineLearningCognitiveSearch({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
