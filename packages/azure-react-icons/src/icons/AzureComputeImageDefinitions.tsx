...
export default function AzureComputeImageDefinitions({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
