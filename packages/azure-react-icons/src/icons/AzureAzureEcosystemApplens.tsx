...
export default function AzureAzureEcosystemApplens({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
