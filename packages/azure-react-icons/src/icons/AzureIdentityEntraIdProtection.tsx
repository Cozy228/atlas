...
export default function AzureIdentityEntraIdProtection({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
