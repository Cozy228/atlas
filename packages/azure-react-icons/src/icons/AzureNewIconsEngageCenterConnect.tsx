...
export default function AzureNewIconsEngageCenterConnect({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
