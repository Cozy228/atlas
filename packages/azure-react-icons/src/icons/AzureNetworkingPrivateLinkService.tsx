...
export default function AzureNetworkingPrivateLinkService({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
