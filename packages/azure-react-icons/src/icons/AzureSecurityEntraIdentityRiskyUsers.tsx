...
export default function AzureSecurityEntraIdentityRiskyUsers({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
