...
export default function AzureOtherAzureVmwareSolution({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
