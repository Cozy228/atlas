...
export default function AzureAnalyticsAzureWorkbooks({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
