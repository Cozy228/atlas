...
export default function AzureNetworkingVirtualRouter({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
