...
export default function AzureNetworkingVirtualWanHub({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
