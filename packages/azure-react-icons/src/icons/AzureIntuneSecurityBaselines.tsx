...
export default function AzureIntuneSecurityBaselines({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
