...
export default function AzureGeneralControlsHorizontal({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
