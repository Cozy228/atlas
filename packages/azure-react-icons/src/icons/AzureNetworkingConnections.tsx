...
export default function AzureNetworkingConnections({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
