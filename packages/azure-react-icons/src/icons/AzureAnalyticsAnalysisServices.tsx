...
export default function AzureAnalyticsAnalysisServices({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
