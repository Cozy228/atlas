...
export default function AzureComputeManagedServiceFabric({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
