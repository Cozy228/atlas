...
export default function AzureOtherAzureSustainability({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
