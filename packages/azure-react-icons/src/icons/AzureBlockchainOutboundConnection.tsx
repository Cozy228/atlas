...
export default function AzureBlockchainOutboundConnection({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
