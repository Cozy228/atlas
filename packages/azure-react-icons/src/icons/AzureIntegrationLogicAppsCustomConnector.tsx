...
export default function AzureIntegrationLogicAppsCustomConnector({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
