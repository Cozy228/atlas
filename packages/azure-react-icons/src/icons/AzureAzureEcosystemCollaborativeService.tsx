...
export default function AzureAzureEcosystemCollaborativeService({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
