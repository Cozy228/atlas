...
export default function AzureNewIconsVpnclientwindows({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
