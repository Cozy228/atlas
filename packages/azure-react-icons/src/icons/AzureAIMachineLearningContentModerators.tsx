...
export default function AzureAIMachineLearningContentModerators({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
