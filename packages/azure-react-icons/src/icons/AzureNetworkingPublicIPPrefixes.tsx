...
export default function AzureNetworkingPublicIPPrefixes({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
