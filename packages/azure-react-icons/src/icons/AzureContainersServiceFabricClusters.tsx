...
export default function AzureContainersServiceFabricClusters({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
