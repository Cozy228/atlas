...
export default function AzureDatabasesSQLElasticPools({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
