...
export default function AzureIdentityExternalIdentities({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
