...
export default function AzureNetworkingNetworkWatcher({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
