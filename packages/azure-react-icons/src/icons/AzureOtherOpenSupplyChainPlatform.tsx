...
export default function AzureOtherOpenSupplyChainPlatform({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
