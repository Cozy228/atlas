...
export default function AzureIntuneDeviceSecurityApple({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
