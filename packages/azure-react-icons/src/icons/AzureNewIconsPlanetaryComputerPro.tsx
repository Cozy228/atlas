...
export default function AzureNewIconsPlanetaryComputerPro({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
