...
export default function AzureNetworkingResourceManagementPrivateLink({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
