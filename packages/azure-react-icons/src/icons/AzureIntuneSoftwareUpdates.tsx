...
export default function AzureIntuneSoftwareUpdates({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
