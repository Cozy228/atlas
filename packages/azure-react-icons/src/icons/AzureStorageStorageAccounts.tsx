...
export default function AzureStorageStorageAccounts({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
