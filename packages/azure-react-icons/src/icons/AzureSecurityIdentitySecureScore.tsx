...
export default function AzureSecurityIdentitySecureScore({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
