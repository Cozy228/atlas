...
export default function AzureOtherVirtualVisitsBuilder({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
