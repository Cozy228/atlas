...
export default function AzureManagementGovernanceResourcesProvider({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
