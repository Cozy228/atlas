...
export default function AzureIoTTimeSeriesInsightsEnvironments({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
