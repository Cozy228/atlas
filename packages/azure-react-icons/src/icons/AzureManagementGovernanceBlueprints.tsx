...
export default function AzureManagementGovernanceBlueprints({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
