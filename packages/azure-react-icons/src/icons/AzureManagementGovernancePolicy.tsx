...
export default function AzureManagementGovernancePolicy({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
