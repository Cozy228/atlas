...
export default function AzureComputeAzureComputeGalleries({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
