...
export default function AzureAnalyticsStreamAnalyticsJobs({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
