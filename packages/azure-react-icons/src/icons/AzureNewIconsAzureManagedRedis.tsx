...
export default function AzureNewIconsAzureManagedRedis({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
