...
export default function AzureAIMachineLearningPersonalizers({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
