...
export default function AzureOtherAzureLoadTesting({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
