...
export default function AzureIntuneDeviceEnrollment({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
