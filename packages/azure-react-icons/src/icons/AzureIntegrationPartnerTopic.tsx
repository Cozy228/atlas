...
export default function AzureIntegrationPartnerTopic({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
