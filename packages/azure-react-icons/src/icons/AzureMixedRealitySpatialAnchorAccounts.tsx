...
export default function AzureMixedRealitySpatialAnchorAccounts({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
