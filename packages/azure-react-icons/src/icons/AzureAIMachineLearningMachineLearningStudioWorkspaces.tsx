...
export default function AzureAIMachineLearningMachineLearningStudioWorkspaces({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
