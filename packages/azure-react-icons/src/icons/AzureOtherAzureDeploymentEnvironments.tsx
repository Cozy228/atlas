...
export default function AzureOtherAzureDeploymentEnvironments({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
