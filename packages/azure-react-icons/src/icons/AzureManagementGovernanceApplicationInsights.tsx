...
export default function AzureManagementGovernanceApplicationInsights({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
