...
export default function AzureIntuneDeviceCompliance({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
