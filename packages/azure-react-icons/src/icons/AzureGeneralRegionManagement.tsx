...
export default function AzureGeneralRegionManagement({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
