...
export default function AzureGeneralCostManagement({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
