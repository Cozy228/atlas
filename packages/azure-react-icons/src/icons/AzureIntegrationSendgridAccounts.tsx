...
export default function AzureIntegrationSendgridAccounts({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
