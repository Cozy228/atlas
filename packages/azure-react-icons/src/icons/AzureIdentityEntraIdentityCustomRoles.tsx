...
export default function AzureIdentityEntraIdentityCustomRoles({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
