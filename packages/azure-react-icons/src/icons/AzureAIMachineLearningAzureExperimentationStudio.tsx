...
export default function AzureAIMachineLearningAzureExperimentationStudio({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
