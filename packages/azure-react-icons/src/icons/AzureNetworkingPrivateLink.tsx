...
export default function AzureNetworkingPrivateLink({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
