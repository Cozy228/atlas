...
export default function AzureComputeWorkspaces00330({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
