...
export default function AzureStorageStorageActions({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
