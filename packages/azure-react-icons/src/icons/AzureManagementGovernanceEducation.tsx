...
export default function AzureManagementGovernanceEducation({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
