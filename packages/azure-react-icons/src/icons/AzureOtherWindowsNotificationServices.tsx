...
export default function AzureOtherWindowsNotificationServices({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
