...
export default function AzureNetworkingLoadBalancers({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
