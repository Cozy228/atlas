...
export default function AzureOtherLogAnalyticsQueryPack({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
