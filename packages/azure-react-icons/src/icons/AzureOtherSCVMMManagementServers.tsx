...
export default function AzureOtherSCVMMManagementServers({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
