...
export default function AzureIntuneDeviceConfiguration({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
