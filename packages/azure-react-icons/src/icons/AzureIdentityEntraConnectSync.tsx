...
export default function AzureIdentityEntraConnectSync({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
