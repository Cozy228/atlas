...
export default function AzureIntegrationSoftwareAsAService({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
