...
export default function AzureAIMachineLearningAIStudio({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
