...
export default function AzureIdentityAppRegistrations({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
