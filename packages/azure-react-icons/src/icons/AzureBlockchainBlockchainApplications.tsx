...
export default function AzureBlockchainBlockchainApplications({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
