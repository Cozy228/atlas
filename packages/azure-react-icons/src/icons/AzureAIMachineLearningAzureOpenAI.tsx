...
export default function AzureAIMachineLearningAzureOpenAI({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
