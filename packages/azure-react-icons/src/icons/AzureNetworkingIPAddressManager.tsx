...
export default function AzureNetworkingIPAddressManager({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
