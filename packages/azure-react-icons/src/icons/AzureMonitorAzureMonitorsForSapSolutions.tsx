...
export default function AzureMonitorAzureMonitorsForSapSolutions({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
