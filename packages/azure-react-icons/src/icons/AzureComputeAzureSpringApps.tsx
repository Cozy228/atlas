...
export default function AzureComputeAzureSpringApps({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
