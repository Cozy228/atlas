...
export default function AzureManagementGovernanceUniversalPrint({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
