...
export default function AzureNetworkingProximityPlacementGroups({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
