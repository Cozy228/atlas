...
export default function AzureDatabasesSSISLiftAndShiftIr({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
