...
export default function AzureNetworkingAzureFirewallManager({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
