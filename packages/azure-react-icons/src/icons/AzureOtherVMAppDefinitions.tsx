...
export default function AzureOtherVMAppDefinitions({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
