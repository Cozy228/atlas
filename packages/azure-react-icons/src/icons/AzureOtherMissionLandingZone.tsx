...
export default function AzureOtherMissionLandingZone({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
