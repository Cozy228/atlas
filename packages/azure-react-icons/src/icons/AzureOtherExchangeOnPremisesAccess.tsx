...
export default function AzureOtherExchangeOnPremisesAccess({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
