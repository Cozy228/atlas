...
export default function AzureManagementGovernanceCustomerLockboxForMicrosoftAzure({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
