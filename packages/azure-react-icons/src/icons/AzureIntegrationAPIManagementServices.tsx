...
export default function AzureIntegrationAPIManagementServices({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
