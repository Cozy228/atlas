...
export default function AzureGeneralPreviewFeatures({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
