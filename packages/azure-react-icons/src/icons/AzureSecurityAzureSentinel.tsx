...
export default function AzureSecurityAzureSentinel({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
