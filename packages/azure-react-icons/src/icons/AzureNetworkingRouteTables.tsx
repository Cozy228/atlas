...
export default function AzureNetworkingRouteTables({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
