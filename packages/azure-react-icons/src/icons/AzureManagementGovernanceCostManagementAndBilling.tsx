...
export default function AzureManagementGovernanceCostManagementAndBilling({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
