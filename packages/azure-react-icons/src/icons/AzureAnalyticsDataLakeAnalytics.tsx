...
export default function AzureAnalyticsDataLakeAnalytics({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
