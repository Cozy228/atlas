...
export default function AzureOtherBareMetalInfrastructure({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
