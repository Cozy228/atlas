...
export default function AzureBlockchainAzureBlockchainService({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
