...
export default function AzureNetworkingVirtualNetworkGateways({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
