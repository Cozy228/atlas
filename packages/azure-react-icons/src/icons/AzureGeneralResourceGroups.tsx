...
export default function AzureGeneralResourceGroups({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
