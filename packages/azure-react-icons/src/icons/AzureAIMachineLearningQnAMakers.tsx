...
export default function AzureAIMachineLearningQnAMakers({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
