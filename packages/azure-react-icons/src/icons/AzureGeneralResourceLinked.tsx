...
export default function AzureGeneralResourceLinked({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
