...
export default function AzureIntegrationAzureServiceBus({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
