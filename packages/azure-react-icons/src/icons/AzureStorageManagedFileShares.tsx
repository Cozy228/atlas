...
export default function AzureStorageManagedFileShares({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
