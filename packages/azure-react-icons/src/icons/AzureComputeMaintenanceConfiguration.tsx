...
export default function AzureComputeMaintenanceConfiguration({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
