...
export default function AzureGeneralMarketplaceManagement({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
