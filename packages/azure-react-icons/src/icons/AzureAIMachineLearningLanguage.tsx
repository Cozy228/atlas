...
export default function AzureAIMachineLearningLanguage({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
