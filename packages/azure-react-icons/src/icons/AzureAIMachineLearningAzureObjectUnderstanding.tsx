...
export default function AzureAIMachineLearningAzureObjectUnderstanding({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
