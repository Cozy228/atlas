...
export default function AzureAzureStackInfrastructureBackup({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
