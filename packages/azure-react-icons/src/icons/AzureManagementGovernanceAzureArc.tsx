...
export default function AzureManagementGovernanceAzureArc({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
