...
export default function AzureComputeCloudServicesClassic({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
