...
export default function AzureOtherDataCollectionRules({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
