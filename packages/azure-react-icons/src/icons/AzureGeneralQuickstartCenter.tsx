...
export default function AzureGeneralQuickstartCenter({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
