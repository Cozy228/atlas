...
export default function AzureDatabasesOracleDatabase({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
