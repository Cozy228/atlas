...
export default function AzureOtherVirtualInstanceForSap({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
