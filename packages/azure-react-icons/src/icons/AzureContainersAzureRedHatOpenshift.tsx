...
export default function AzureContainersAzureRedHatOpenshift({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
