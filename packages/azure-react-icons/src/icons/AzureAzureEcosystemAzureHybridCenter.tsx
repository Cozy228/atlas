...
export default function AzureAzureEcosystemAzureHybridCenter({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
