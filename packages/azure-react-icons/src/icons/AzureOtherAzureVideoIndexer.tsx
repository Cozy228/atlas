...
export default function AzureOtherAzureVideoIndexer({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
