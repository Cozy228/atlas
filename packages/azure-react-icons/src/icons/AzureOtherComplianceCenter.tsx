...
export default function AzureOtherComplianceCenter({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
