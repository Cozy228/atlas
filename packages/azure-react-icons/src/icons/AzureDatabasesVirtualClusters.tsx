...
export default function AzureDatabasesVirtualClusters({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
