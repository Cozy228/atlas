...
export default function AzureManagementGovernanceMetrics({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
