...
export default function AzureSecurityMultifactorAuthentication({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
