...
export default function AzureAIMachineLearningServerlessSearch({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
