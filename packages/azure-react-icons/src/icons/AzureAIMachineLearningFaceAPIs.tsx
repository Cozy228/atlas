...
export default function AzureAIMachineLearningFaceAPIs({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
