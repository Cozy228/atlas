...
export default function AzureManagementGovernanceDiagnosticsSettings({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
