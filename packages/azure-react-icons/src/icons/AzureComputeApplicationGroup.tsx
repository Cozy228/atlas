...
export default function AzureComputeApplicationGroup({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
