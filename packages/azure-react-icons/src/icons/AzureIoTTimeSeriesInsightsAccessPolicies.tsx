...
export default function AzureIoTTimeSeriesInsightsAccessPolicies({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
