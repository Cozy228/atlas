...
export default function AzureIdentityEntraIdentityLicenses({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
