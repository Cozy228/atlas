...
export default function AzureMixedRealityRemoteRendering({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
