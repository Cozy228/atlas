...
export default function AzureIntegrationDataFactories({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
