...
export default function AzureAzureStackUserSubscriptions({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
