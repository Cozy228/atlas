...
export default function AzureOtherTargetsManagement({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
