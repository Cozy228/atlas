...
export default function AzureManagementGovernanceArcMachines({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
