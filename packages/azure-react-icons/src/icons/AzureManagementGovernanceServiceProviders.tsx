...
export default function AzureManagementGovernanceServiceProviders({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
