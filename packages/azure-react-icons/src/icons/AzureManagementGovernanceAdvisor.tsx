...
export default function AzureManagementGovernanceAdvisor({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
