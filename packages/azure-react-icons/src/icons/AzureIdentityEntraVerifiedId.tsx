...
export default function AzureIdentityEntraVerifiedId({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
