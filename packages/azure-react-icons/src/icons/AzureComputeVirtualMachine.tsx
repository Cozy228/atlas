...
export default function AzureComputeVirtualMachine({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
