...
export default function AzureIdentityEntraIdentityRolesAndAdministrators({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
