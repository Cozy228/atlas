...
export default function AzureDatabasesSQLManagedInstance({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
