...
export default function AzureAIMachineLearningGenomics({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
