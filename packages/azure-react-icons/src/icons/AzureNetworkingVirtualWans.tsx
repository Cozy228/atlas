...
export default function AzureNetworkingVirtualWans({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
