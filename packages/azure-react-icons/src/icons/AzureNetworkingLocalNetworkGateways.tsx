...
export default function AzureNetworkingLocalNetworkGateways({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
