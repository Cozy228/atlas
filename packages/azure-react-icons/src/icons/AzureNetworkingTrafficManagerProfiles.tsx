...
export default function AzureNetworkingTrafficManagerProfiles({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
