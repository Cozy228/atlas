...
export default function AzureIdentityTenantProperties({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
