...
export default function AzureComputeSharedImageGalleries({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
