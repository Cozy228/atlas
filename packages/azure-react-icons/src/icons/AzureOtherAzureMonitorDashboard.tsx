...
export default function AzureOtherAzureMonitorDashboard({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
