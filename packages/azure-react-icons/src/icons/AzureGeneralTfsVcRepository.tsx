...
export default function AzureGeneralTfsVcRepository({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
