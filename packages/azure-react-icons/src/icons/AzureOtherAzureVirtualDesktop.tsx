...
export default function AzureOtherAzureVirtualDesktop({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
