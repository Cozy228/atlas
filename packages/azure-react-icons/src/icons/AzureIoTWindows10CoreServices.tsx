...
export default function AzureIoTWindows10CoreServices({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
