...
export default function AzureDatabasesManagedDatabase({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
