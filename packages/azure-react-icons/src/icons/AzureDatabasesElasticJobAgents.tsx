...
export default function AzureDatabasesElasticJobAgents({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
