...
export default function AzureIntegrationBusinessProcessTracking({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
