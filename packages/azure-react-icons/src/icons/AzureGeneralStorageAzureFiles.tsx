...
export default function AzureGeneralStorageAzureFiles({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
