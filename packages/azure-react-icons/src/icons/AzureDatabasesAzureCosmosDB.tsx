...
export default function AzureDatabasesAzureCosmosDB({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
