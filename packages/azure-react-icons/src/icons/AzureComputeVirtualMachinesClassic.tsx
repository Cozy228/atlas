...
export default function AzureComputeVirtualMachinesClassic({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
