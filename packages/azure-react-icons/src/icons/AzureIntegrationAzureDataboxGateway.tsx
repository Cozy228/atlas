...
export default function AzureIntegrationAzureDataboxGateway({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
