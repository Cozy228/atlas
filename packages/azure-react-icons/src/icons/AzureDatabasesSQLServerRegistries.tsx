...
export default function AzureDatabasesSQLServerRegistries({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
