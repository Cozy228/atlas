...
export default function AzureIdentityVerificationAsAService({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
