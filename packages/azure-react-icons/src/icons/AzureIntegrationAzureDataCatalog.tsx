...
export default function AzureIntegrationAzureDataCatalog({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
