...
export default function AzureSecurityEntraIdentityRiskySignins({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
