...
export default function AzureNetworkingLoadBalancerHub({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
