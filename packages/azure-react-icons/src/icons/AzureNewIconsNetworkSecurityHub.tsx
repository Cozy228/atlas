...
export default function AzureNewIconsNetworkSecurityHub({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
