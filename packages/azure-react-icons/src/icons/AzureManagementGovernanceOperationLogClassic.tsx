...
export default function AzureManagementGovernanceOperationLogClassic({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
