...
export default function AzureNetworkingConnectedCache({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
