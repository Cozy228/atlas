...
export default function AzureOtherCloudServicesExtendedSupport({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
