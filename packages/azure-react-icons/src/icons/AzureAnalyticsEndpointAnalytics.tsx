...
export default function AzureAnalyticsEndpointAnalytics({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
