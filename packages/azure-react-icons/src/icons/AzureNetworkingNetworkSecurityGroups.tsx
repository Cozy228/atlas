...
export default function AzureNetworkingNetworkSecurityGroups({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
