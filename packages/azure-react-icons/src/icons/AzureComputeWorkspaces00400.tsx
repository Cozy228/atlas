...
export default function AzureComputeWorkspaces00400({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
