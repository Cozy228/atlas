...
export default function AzureAzureStackMultiTenancy({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
