...
export default function AzureIoTTimeSeriesInsightsEventSources({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
