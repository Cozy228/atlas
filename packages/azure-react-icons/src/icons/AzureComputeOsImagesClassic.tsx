...
export default function AzureComputeOsImagesClassic({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
