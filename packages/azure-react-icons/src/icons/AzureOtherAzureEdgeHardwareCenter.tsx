...
export default function AzureOtherAzureEdgeHardwareCenter({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
