...
export default function AzureAIMachineLearningMachineLearningStudioWebServicePlans({ size = 24, ...props }: AzureIconProps) {
  return (
    <svg
      {...props}
      width={size}
