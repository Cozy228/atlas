    ...
    <aside className="flex min-w-0 flex-col gap-8 lg:border-l lg:border-border lg:pl-7">
      ...
      <RailModule label="Editor's note">
        <p className="bg-background text-[12px] leading-[1.6] text-muted-foreground">
          Every entry links back to the surface that owns it — a catalog page, a guidance route, or a
          source record. Read the dispatch top-down for the day&rsquo;s shape, or jump by type.
        </p>
      </RailModule>
    </aside>
  );
