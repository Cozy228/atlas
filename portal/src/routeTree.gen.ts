...
'/': typeof IndexRoute,'/ask': typeof AskRoute,'/capabilities': typeof CapabilitiesRouteWithChildren,'/landing-zones': typeof LandingZonesRouteWithChildren,'/sources': typeof SourcesRouteWithChildren,'/capabilities/$topicId': typeof CapabilitiesTopicIdRoute,'/landing-zones/$topicId': typeof LandingZonesTopicIdRoute,'/sources/$sourceId': typeof SourcesSourceIdRoute,'/capabilities/': typeof CapabilitiesIndexRoute,'/landing-zones/': typeof LandingZonesIndexRoute,'/sources/': typeof SourcesIndexRoute
}
...
fullPaths: '/'|'/ask'|'/capabilities'|'/landing-zones'|'/sources'|'/capabilities/$topicId'|'/landing-zones/$topicId'|'/sources/$sourceId'|'/capabilities/'|'/landing-zones/'|'/sources/'
fileRoutesByTo: FileRoutesByTo
to: '/'|'/ask'|'/capabilities/$topicId'|'/landing-zones/$topicId'|'/sources/$sourceId'|'/capabilities'|'/landing-zones'|'/sources'
id: '__root__'|'/'|'/ask'|'/capabilities'|'/landing-zones'|'/sources'|'/capabilities/$topicId'|'/landing-zones/$topicId'|'/sources/$sourceId'|'/capabilities/'|'/landing-zones/'|'/sources/'
fileRoutesById: FileRoutesById
}
export interface RootRouteChildren {
IndexRoute: typeof IndexRoute,AskRoute: typeof AskRoute,CapabilitiesRoute: typeof CapabilitiesRouteWithChildren,LandingZonesRoute: typeof LandingZonesRouteWithChildren,SourcesRoute: typeof SourcesRouteWithChildren
}
...
const rootRouteChildren: RootRouteChildren = {
  IndexRoute: IndexRoute,AskRoute: AskRoute,CapabilitiesRoute: CapabilitiesRouteWithChildren,LandingZonesRoute: LandingZonesRouteWithChildren,SourcesRoute: SourcesRouteWithChildren
}
