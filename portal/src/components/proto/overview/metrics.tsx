/**
 * PROTOTYPE (production candidate) — dashboard primitives shared by the
 * `/proto/overview` directions: deterministic sparklines (stable across SSR),
    ...
    <div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
      <svg width={size} height={size} className="-rotate-90" aria-hidden>
        ...
        <circle
          ...
          className={cn("transition-[stroke-dasharray] duration-500 motion-reduce:transition-none", tone)}
          stroke="currentColor"
        />
      </svg>
