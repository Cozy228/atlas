/**
 * PROTOTYPE (production candidate) — shared kit for the `/proto/guidance` index
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center justify-center gap-2 border-l border-dashed border-border bg-brand-tint/50">
        <span aria-hidden className="absolute -top-1.5 left-0 size-3 -translate-x-1/2 rounded-full bg-background" />
        <span aria-hidden className="absolute -bottom-1.5 left-0 size-3 -translate-x-1/2 rounded-full bg-background" />
