/**
 * PROTOTYPE (production candidate) — shared catalog model for the
 * `/proto/catalog` directions that render the full availability projection
 * (60 services × 12 domains) enriched by real topics. Fictional, public-safe
 * copy ported from the round-1 prototype.
 */
