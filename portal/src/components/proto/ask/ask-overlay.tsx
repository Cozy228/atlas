/**
 * PROTOTYPE (production candidate) — Ask Atlas in-place overlay (dialog).
 *
 ...
 * `/proto/ask` reference page, reached from the Ask footer's "Owning teams" link.
 *
...
export function ProtoAskOverlay({
  open,
  onOpenChange,
  tab,
  onTabChange,
