/**
 * PROTOTYPE (scale fixture) — synthetic source set for stress-testing the
...
const CATEGORY_GROUPS: ReadonlyArray<readonly [string, ReadonlyArray<string>]> = [
  // terraform-module
  ["Networking", ["vpc-landing-zone", "alb-ingress", "route53-zone", "vpc-peering", "transit-gateway", "cloudfront-cdn", "waf-web-acl"]],
  ["Compute & Runtime", ["eks-baseline", "lambda-function", "ecr-registry", "step-functions"]],
  ["Storage & Data", ["s3-secure-bucket", "rds-postgres", "dynamodb-table", "elasticache-redis", "opensearch-domain"]],
  ["Messaging", ["sqs-queue", "sns-topic", "eventbridge-bus"]],
  ["Security & IAM", ["kms-key-ring", "secrets-manager", "iam-role-factory"]],
  // confluence-page
  ["Runbooks", ["onboarding-runbook", "incident-response", "on-call-handbook", "disaster-recovery", "migration-playbook"]],
  ["How-to Guides", ["local-dev-setup", "release-process", "cost-optimization", "support-escalation", "new-team-faq"]],
  ["Standards", ["logging-conventions", "naming-standards", "tagging-guide", "slo-definitions"]],
  ["Reference", ["service-catalog-overview", "deployment-checklist", "architecture-decisions", "glossary"]],
  // policy-document
  ["Security Policy", ["access-control", "encryption-requirements", "network-segmentation", "key-rotation"]],
  ["Privacy & Data", ["data-classification", "privacy-standard", "retention-schedule", "third-party-sharing"]],
  ["Governance", ["acceptable-use", "change-management", "vendor-risk", "audit-logging", "incident-disclosure", "backup-policy"]],
];
