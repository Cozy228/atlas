/**
 * Dev density fixture — synthetic skills for stress-testing the
 * `/skills` directions (Tool shelf + Man pages) at realistic volume.
 *
 ...
 * a `getProtoSkill` lookup the detail route resolves through — the same
 * pattern as `resolveGuidanceFlow`. Nothing here touches the mainline `/skills`.
 */
  ...
  [
    ...
    [
      [
        "Service Skeleton",
        "service-skeleton",
        "Generates a service repo with the approved layout and CI.",
        "scaffold ci repo",
      ],
      [
        "Container Baseline",
        "container-baseline",
        "Scaffolds a hardened Dockerfile and build pipeline.",
        "docker build",
      ],
      [
        "Helm Chart Starter",
        "helm-chart-starter",
        "Lays down a chart wired to the platform values.",
        "helm k8s",
      ],
      [
        "Lambda Scaffold",
        "lambda-scaffold",
        "Bootstraps a serverless function with tracing on.",
        "serverless",
      ],
      [
        "API Spec Init",
        "api-spec-init",
        "Seeds an OpenAPI spec and contract tests.",
        "api openapi",
      ],
      [
        "Frontend App Init",
        "frontend-app-init",
        "Scaffolds an SPA with the design system pre-wired.",
        "frontend ui",
      ],
      [
        "Data Pipeline Init",
        "data-pipeline-init",
        "Generates a batch pipeline with schema checks.",
        "data etl",
      ],
    ],
  ],
  [
    ...
    [
      [
        "Catalog Register",
        "catalog-register",
        "Registers a service and its ownership metadata.",
        "catalog onboard",
      ],
      [
        "Ownership Sync",
        "ownership-sync",
        "Reconciles team ownership against the directory.",
        "ownership",
      ],
      [
        "Cost Center Tag",
        "cost-center-tag",
        "Attaches billing tags and a budget alert.",
        "cost billing",
      ],
      [
        "On-Call Wire-Up",
        "oncall-wireup",
        "Connects a service to its escalation rota.",
        "oncall ops",
      ],
      [
        "SLO Bootstrap",
        "slo-bootstrap",
        "Seeds default SLOs and an error budget policy.",
        "slo reliability",
      ],
      [
        "Access Request",
        "access-request",
        "Files the standard access grant for a new team.",
        "access iam",
      ],
    ],
  ],
  [
    ...
    [
      [
        "Evidence Lint",
        "evidence-lint",
        "Checks citations resolve to live anchors.",
        "evidence lint",
      ],
      [
        "Guardrail Check",
        "guardrail-check",
        "Dry-runs guardrail policies against a plan.",
        "guardrails policy",
      ],
      [
        "Dependency Audit",
        "dependency-audit",
        "Scans and pins third-party dependencies.",
        "security deps",
      ],
      [
        "Config Drift Scan",
        "config-drift-scan",
        "Diffs live config against the recorded baseline.",
        "drift config",
      ],
      [
        "Accessibility Lint",
        "accessibility-lint",
        "Flags a11y violations before release.",
        "a11y quality",
      ],
      [
        "License Sweep",
        "license-sweep",
        "Verifies dependency licenses are allowed.",
        "license legal",
      ],
      [
        "Secret Scan",
        "secret-scan",
        "Looks for leaked credentials in the repo.",
        "secrets security",
      ],
      [
        "Perf Budget Check",
        "perf-budget-check",
        "Asserts bundle and latency budgets hold.",
        "perf quality",
      ],
    ],
  ],
  [
    ...
    [
      [
        "Region Promote",
        "region-promote",
        "Promotes a change across regions in waves.",
        "rollout regions",
      ],
      [
        "Canary Deploy",
        "canary-deploy",
        "Ships a canary and watches its health gates.",
        "canary deploy",
      ],
      [
        "Feature Flag Roll",
        "feature-flag-roll",
        "Steps a flag through its exposure ramp.",
        "flags rollout",
      ],
      [
        "Blue-Green Switch",
        "blue-green-switch",
        "Shifts traffic between two live stacks.",
        "deploy traffic",
      ],
      ...
      [
        "Migration Runner",
        "migration-runner",
        "Applies a schema migration with a backout.",
        "migration data",
      ],
    ],
  ],
  [
    ...
    [
      [
        "Context Bundle",
        "context-bundle",
        "Packages platform knowledge for an agent.",
        "context agents",
      ],
      [
        "Runbook Export",
        "runbook-export",
        "Renders runbooks into an agent-readable form.",
        "runbook docs",
      ],
